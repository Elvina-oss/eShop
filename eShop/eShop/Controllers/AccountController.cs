    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginVM loginVM)
        {
            ...
            if (user != null)
            {
                ...
                TempData["Error"] = "Неправильные пароль или почта. Попробуйте еще раз!";
                return View(loginVM);
            }

            TempData["Error"] = "Что-то неправильно. Попробуйте еще раз!";
            return View(loginVM);
        }
        ...
        public async Task<IActionResult> Register(RegisterVM registerVM)
        {
            ...
            if(user != null)
            {
                TempData["Error"] = "Аккаунт с такой почтой уже существует";
                return View(registerVM);
            }
